  ...
  return (
    <>
      ...
      <div style={{ padding: '20px', maxWidth: '80%', margin: '0 auto'}}>
        <h1 style={{ color: '#333', textAlign: 'center' }}>Acerca de Nosotros</h1><br />
        ...
        <h2 style={{ color: '#444', marginTop: '20px' }}>Nuestra Misión</h2>
        <p style={{ color: '#555', marginBottom: '20px' }}>
        ...
        <h2 style={{ color: '#444', marginTop: '20px' }}>Contacto</h2>
        <p style={{ color: '#555' }}>
          Si tienes alguna pregunta o necesitas ayuda, no dudes en contactarnos a través de nuestro correo electrónico:
          <a href="mailto:contacto@tienda.com" style={{ color: '#007BFF', textDecoration: 'none' }}>contacto@floresdelatierra.com</a>
